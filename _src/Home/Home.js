...
export default function Home({navigation}) {
  ...
  const loadMore = () => {
    ...
    setLimit(limit + 5);
    CallBookAll(null, limit + 2).then(e => {
      setData(e), console.log(e.length);
    });
  };
        ...
        ListFooterComponent={() => {
          return (
            <View
              ...
              <View
                style={{width: '30%', height: 0.5, backgroundColor: 'black'}}
              />
              <Text
                onPress={() => loadMore()}
